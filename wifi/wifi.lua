...
if(conf.mode=='station') then
   print("INFO: wifi connecting to "..conf.station.config.ssid.." ...")
   ...
   wifi.eventmon.register(wifi.eventmon.STA_GOT_IP,function(args)
      print("INFO: wifi ",conf.station.config.ssid,wifi.sta.getip())
      dofile("net.up.lua")
   ...
   print("INFO: wifi "..conf.ap.config.ssid.." access point ("..wifi.sta.getmac()..")")
   dofile("net.up.lua")
end
