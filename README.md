...
Note ESP32 users: currently `nodemcu-tool` doesn't support ESP32, see [NodeMCU-Tool with ESP32 support](https://github.com/Spiritdude/NodeMCU-Tool), contains a patch so ESP32 is supported as well, I expect my PR or equivalant being included soon in the original repo (2018/02/04).
